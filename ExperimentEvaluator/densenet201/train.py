...
from model import densenet121, densenet161, densenet169, densenet201, densenet100bc, densenet190bc

from utils import compute_mean_var, norm_images, unpickle, generate_tfrecord, norm_images_using_mean_var, \
    lr_schedule_200ep, lr_schedule_300ep
...
if __name__ == "__main__":
    ...
    parser_train.add_argument('--epoch', default=200, type=int)
    parser_train.add_argument('--network', default='densenet201')
    parser_train.add_argument('--opt', default='momentum')
    parser_train.add_argument('--train_path', default='/data/data/cifar-100-python/train')
    parser_train.add_argument('--test_path', default='/data/data/cifar-100-python/test')
